...
// HashPassword generates a secure Argon2id hash of the password.
...
func HashPassword(password string) (string, error) {
	...
	// Return the string using the standard PHC string format.
...
// It parses the hash string to extract parameters, ensuring future compatibility.
