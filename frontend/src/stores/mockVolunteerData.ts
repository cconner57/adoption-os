...
export const mockVolunteers: IVolunteer[] = [
  // Tier 2
  {
    ...
    skills: ['Cat Behavior Training', 'Medication Administration'],
    ...
    positionPreferences: ['Feeding/Cleaning', 'Cat Socializing'],
    availability: ['10AM – 12PM', '2PM – 4PM'],
    totalHours: 320,
    streak: 24,
    badges: [
      'New Recruit',
  ...
  },
  {
    ...
    skills: ['Logistics', 'Feeding/Cleaning'],
    reliabilityScore: 96,
    address: '202 Oak Ave',
    city: 'Springfield',
    zip: '90210',
    ...
    positionPreferences: ['Feeding/Cleaning', 'Customer Support'],
    availability: ['4PM – 6PM'],
    totalHours: 410,
    streak: 8,
  ...
  },
  {
    ...
    skills: ['Cat Socializing', 'Photography'],
    reliabilityScore: 98,
    ...
    positionPreferences: ['Cat Socializing'],
    availability: ['6PM – 8PM', 'Adoption Event: 12pm - 2pm'],
    totalHours: 180,
    streak: 15,
  ...
  // Tier 1
  {
    ...
    skills: ['Feeding/Cleaning', 'Feeding/Cleaning'],
    reliabilityScore: 92,
    address: '404 Elm St',
    city: 'Springfield',
    zip: '90210',
    ...
    positionPreferences: ['Feeding/Cleaning'],
  ...
  },
  {
    ...
    positionPreferences: ['Feeding/Cleaning'],
    availability: ['Adoption Event: 12pm - 2pm', 'Adoption Event: 2pm - 4pm'],
    totalHours: 0,
    streak: 0,
    badges: ['New Recruit'],
  },
  {
    ...
    positionPreferences: ['Feeding/Cleaning'],
    availability: ['Adoption Event: 2pm - 4pm'],
    totalHours: 80,
    streak: 3,
  ...
  },
  {
    ...
    skills: ['Feeding/Cleaning', 'Organization'],
    reliabilityScore: 97,
  ...
  },
  {
    ...
    availability: ['10AM – 12PM', '12PM – 2PM'],
    totalHours: 300,
    streak: 40,
  ...
  },
  {
    ...
    skills: ['Photography', 'Cat Socializing'],
    reliabilityScore: 94,
    ...
    positionPreferences: ['Customer Support', 'Cat Socializing'],
    availability: ['Adoption Event: 2pm - 4pm'],
    totalHours: 70,
    streak: 5,
  ...
  },
  {
    ...
    skills: ['Feeding/Cleaning', 'Observation'],
    reliabilityScore: 100,
    address: '1818 Fir St',
    city: 'Springfield',
    zip: '90210',
    ...
    positionPreferences: ['Feeding/Cleaning'],
    availability: ['Adoption Event: 12pm - 2pm'],
    totalHours: 110,
    streak: 15,
  ...
  },
  {
    ...
    skills: ['Customer Support', 'Organization'],
    reliabilityScore: 98,
    ...
    positionPreferences: ['Customer Support'],
    availability: ['4PM – 6PM'],
    totalHours: 75,
    streak: 9,
    badges: ['Rising Star', '50 Hours'],
